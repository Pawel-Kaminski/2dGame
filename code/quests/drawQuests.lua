...
require "quests.drawQuests.showEnding"
...
function drawQuests(numberOfItems)
    ...
    elseif screenId == 2 then
        ...
        for i=1, numberOfItems do
            if items[i][2] ~= 0 then
                love.graphics.printf(
                    items[i][1], 100, yPosition, 1820, "left", 0)
                love.graphics.printf(
                    items[i][2], 800, yPosition, 1820, "left", 0)
    ...
    elseif screenId == 1 then
        ...
        for i=1, numberOfQuests do
            if quests[i][3] then
                ...
                love.graphics.printf(
                    quests[i][1], 100, yPosition, 1820, "left", 0)
                love.graphics.printf(
                    quests[i][2], 120, yPosition + 40, 1820, "left", 0)
    ...
    elseif screenId == 3 then
        ...
        for i=1, numberOfFlags do
            ...
            love.graphics.printf(
                playerActionFlags[i][1], 100, yPosition, 1820, "left", 0)
            love.graphics.printf(
                playerActionFlags[i][4], 120, yPosition + 40, 1820, "left", 0)
            yPosition = yPosition + 100
        end
    end
end
